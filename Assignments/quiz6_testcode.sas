...
proc sgplot data=sashelp.class;
   scatter x=Height y=Weight /
      markerattrs=(color=maroon symbol=star);
run;*/
...
data table;
  ...
  datalines;
F A 3465  F C 1281  M A 2938  M C 989
;

proc format;
  value $ a    "A" = "Adult"  "C" = "Child";
...
proc freq;
   ...
   weight count;
   format age $a. gender $sex.;
run;*/

%MACRO sorter(sort_field=);
   proc sort;
      by &sort_field;
%MEND;
